            ...
            >
              <div className="relative bg-card rounded-2xl overflow-hidden shadow-card hover:shadow-elevated transition-all duration-300 h-full">
                ...
                <div className="absolute bottom-0 left-0 right-0 p-4 md:p-6 z-20">
                  <div className="w-12 h-12 md:w-14 md:h-14 rounded-xl btn-gradient flex items-center justify-center mb-3 md:mb-4 shadow-lg">
                    <category.icon className="w-6 h-6 md:w-7 md:h-7 text-primary-foreground" />
                  </div>
